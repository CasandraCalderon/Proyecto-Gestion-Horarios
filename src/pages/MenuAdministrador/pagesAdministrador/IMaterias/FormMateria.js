        ...
        <>
            ...
            {props.error?.includes("vacios") && <div id="alertHelp" className="form-text">{props.error}</div>}
                      <label htmlFor="Nombre">Nombre</label>
                        ...
                        <input autocomplete="off" className="form-control" type="text" name="Sigla" id="Sigla" onChange={props.handleChange} value={props.form?props.form.Sigla: ''}/>
                        ...
                        <input autocomplete="off" className="form-control" type="number" name="CantHSemanas" id="CantHSemanas" onChange={props.handleChange} value={props.form?props.form.CantHSemanas:''}/>
                        <br />
                      </div>
        </>
    )
