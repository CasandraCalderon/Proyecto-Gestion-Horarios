    ...
    return (
          ...
          {this.state.data.map(usuario=>{
              ...
              return(
                  <tr key={usuario._id}>
                      ...
                      <td className="Sec">
                  <button className="btn btn-success" onClick={()=>{this.seleccionarUsuario(usuario); this.modalInsertar()}}><FontAwesomeIcon icon={faEye}/></button>
                  {"   "}
      ...
      <Modal isOpen={this.state.modalInsertar}>
            ...
            <Modal isOpen={this.state.modalEliminar}>
              <ModalBody>
                 ¿Estás seguro que deseas eliminar este Docente? {form && form.Nombres}
              </ModalBody>
              <ModalFooter>
