...
class IAulas extends Component {
  ...
  optionsSalas = (selectedOpSalas) => {
    ...
    this.setState({
      ...
      form: {
        ...this.state.form,
        TipoSala: selectedOpSalas.value,
      },
    });
    console.log(this.state.form);
  };
        ...
        <Modal isOpen={this.state.modalInsertar}>
          ...
          <ModalBody>
            <div className="form-group">
              ...
              <Select
                value={form ? form.Piso : selectedOption}
              ...
              <input
                ...
                id="Capacidad"
                onChange={this.handleChange}
                value={form ? form.Capacidad : ""}
              />
              <br />
              <label htmlFor="TipoSala">Sala</label>
              <Select
                value={form ? form.TipoSala : selectedOpSalas}
                onChange={this.optionsSalas}
                options={op_salas}
              />
              <br />
            </div>
